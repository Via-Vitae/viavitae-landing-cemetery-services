...
[![CI](https://github.com/Via-Vitae/viavitae-landing-cemetery-services/actions/workflows/ci.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-cemetery-services/actions/workflows/ci.yml)
[![Compliance](https://github.com/Via-Vitae/viavitae-landing-cemetery-services/actions/workflows/compliance-check.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-cemetery-services/actions/workflows/compliance-check.yml)
[![CodeQL](https://github.com/Via-Vitae/viavitae-landing-cemetery-services/actions/workflows/codeql.yml/badge.svg)](https://github.com/Via-Vitae/viavitae-landing-cemetery-services/actions/workflows/codeql.yml)
...
`viavitae-landing-cemetery-services` is the single source of truth for how a ViaVitae repository looks.
...
gh repo create Via-Vitae/viavitae-<name> \
  --template Via-Vitae/viavitae-landing-cemetery-services \
  --private \
...
cd viavitae-<name>
git remote add upstream git@github.com:Via-Vitae/viavitae-landing-cemetery-services.git
```
...
Every ViaVitae repository is generated from `viavitae-landing-cemetery-services`. Governance files are not
